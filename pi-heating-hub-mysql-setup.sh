...
CREATE TABLE timers        ( id  INT, name VARCHAR(256), duration INT, start TIME, value BOOLEAN );
...
CREATE TABLE schedules        ( id INT, name VARCHAR(256),          start TIME, end TIME,   dow INT, value BOOLEAN );
...
CREATE TABLE sched_output        ( id INT, sched_id INT, output_id INT );
...
CREATE TABLE sched_timers        ( id INT, sched_id INT, timer_id INT, opp CHAR, value BOOLEAN );
INSERT INTO  sched_timers VALUES ( 1,      1,            1,            '=',      False );

CREATE TABLE sched_modes         ( id INT, sched_id INT, mode_id INT, opp CHAR, value BOOLEAN );
